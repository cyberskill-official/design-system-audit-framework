...
```bash
rg -n "\b(the )?DSAF Framework\b|\bDSAF framework\b|CyberSkill'?s framework|CyberSkill framework|no-silent-regression rule" README.md CONTRIBUTING.md docs/01-introduction.md docs/02-framework.md docs/07-maturity-tiers.md landing docs/social
```
...
- `docs/02-framework.md` — H1 normalized from "DSAF framework spec" to "DSAF Operating Spec".
...
- `docs/social/README.md` and `docs/social/show-hn.md` — social guidance avoids banned noun-handle and legacy rule phrasing.
