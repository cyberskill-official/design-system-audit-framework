...
Generated outputs MUST NOT include commercial packaging, pricing, lead magnets, service plans, or monetization strategy. Those belong in source documentation such as `internal/strategy/framework-monetization-plan.md`.
...
- `outputs/generated/design-md-fixtures/`
- `outputs/generated/maximal-cases/`

It must produce 10 direct file cases, 0 URL cases, and 20 output files.
