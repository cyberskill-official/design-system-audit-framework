...
|---|---|---|---|---|---|---|
| A1 | **Smoke-test the live deploy.** Run every `curl` command in `docs/ops/deploy-runbook.md` §3 against `https://audit.cyberskill.world/`. Capture output. | agent | `docs/ops/deploy-smoke-2026-05-18.md` (log file with all command output) | — | todo | Every command returns expected status; no broken routes |
...
| A7 | **Re-run BRAND-002 ACs** against the live deploy. Per FR-BRAND-002 §5 verification commands. | agent | `docs/branding/brand-audit-2026-05-18.md` | A1 | todo | All grep checks return 0 banned phrases; report committed |
