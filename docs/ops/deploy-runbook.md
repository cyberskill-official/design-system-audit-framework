...
The `landing/` folder is deployed via Vercel and serves at `https://audit.cyberskill.world/`. This is the canonical, stable URL — no domain migration is planned. See [`docs/branding/domain-decision.md`](../branding/domain-decision.md) for the rationale.
...
| OPS-002 | No analytics decision logged | `docs/ops/analytics-decision.md` — choose Plausible self-hosted on a Cloudflare Worker OR document "no analytics in P0" deferral until FR-BENCH-001 P4 | todo |
