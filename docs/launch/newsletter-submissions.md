...
| Account login, 2FA, or CAPTCHA appears | physical blocker | Do not bypass; use the mock contract and manual handoff | `docs/social/FR-LAUNCH-006-social-payload.json` |
