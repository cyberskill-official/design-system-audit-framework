...
This is the operating manual for the first 24 hours after posting `docs/launch/show-hn-post.md`.
...
2. Log the trigger in `docs/launch/post-hn-feedback.md`.
...
Use `docs/launch/post-hn-feedback.md` as the live tracker.
...
- Summarize the top three critique patterns in `docs/launch/post-hn-feedback.md`.
