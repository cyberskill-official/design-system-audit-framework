...
Each prompt declares hard rules the agent must refuse to violate (per [`01-framework-overview.md`](../framework/01-framework-overview.md) §7). Examples:
...
*This concludes the framework documentation. Read the prompts themselves at [`../prompts/`](./prompts), the criteria at [`03-criteria-part-a.md`](../framework/03-criteria-part-a.md) and [`04-criteria-part-b.md`](../framework/04-criteria-part-b.md), or jump to the canonical case study under [`../framework/examples/`](../framework/examples).*
