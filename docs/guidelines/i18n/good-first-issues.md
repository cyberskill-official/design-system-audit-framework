...
```markdown
Translate framework/dsaf-25.md and the first 200 words of README.md into Japanese.
Keep criterion IDs unchanged.
Use guidelines/i18n/translation-guidelines.md for terminology.
...
```markdown
Translate framework/dsaf-25.md and the first 200 words of README.md into Spanish.
Keep criterion IDs unchanged.
Use guidelines/i18n/translation-guidelines.md for terminology.
Do not translate `DSAF` or `DSAF-25 Core`.
...
```markdown
Translate framework/dsaf-25.md and the first 200 words of README.md into German.
Keep criterion IDs unchanged.
Use guidelines/i18n/translation-guidelines.md for terminology.
Do not translate `DSAF` or `DSAF-25 Core`.
