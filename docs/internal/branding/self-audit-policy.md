...
The CyberSkill example in [`examples/cyberskill-design-system/`](../../framework/examples/cyberskill-design-system) is a complete worked example of a DSAF self-audit.
