...
**Subject:** `DSAF launches next week — would value your roast`
...
Update `internal/launch/personal-outreach.md` table per recipient:

| Name | Sent (date) | Reply (date) | Outcome |
|---|---|---|---|
| Brad Frost | | | |
| Nathan Curtis | | | |
| Sil Bormüller | | | |
...
Outcomes: `no-reply`, `reply-no-action`, `feedback-incorporated`, `feedback-public`, `endorsement-approved`, `declined`.

*End of personal outreach drafts.*
