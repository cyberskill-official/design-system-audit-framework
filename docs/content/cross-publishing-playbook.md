...
|---|---|---|---|
| Canonical article | Tuesday, 2026-06-16, 08:00 PT | Tuesday, 2026-06-16, 22:00 ICT | `docs/content/deep-dives/week-01-a1-1-color-tokens.md` |
| dev.to | Wednesday, 2026-06-17, 08:00 PT | Wednesday, 2026-06-17, 22:00 ICT | `docs/content/deep-dives/cross-publishing/week-01-a1-1-color-tokens.devto.md` |
| Medium | Thursday, 2026-06-18, 08:00 PT | Thursday, 2026-06-18, 22:00 ICT | `docs/content/deep-dives/cross-publishing/week-01-a1-1-color-tokens.medium.md` |
| LinkedIn long-form | Friday, 2026-06-19, 08:00 PT | Friday, 2026-06-19, 22:00 ICT | `docs/content/deep-dives/cross-publishing/week-01-a1-1-color-tokens.linkedin.md` |
...
2. Open `docs/content/deep-dives/cross-publishing/<slug>.devto.md`.
...
2. Open `docs/content/deep-dives/cross-publishing/<slug>.medium.md`.
...
3. Open `docs/content/deep-dives/cross-publishing/<slug>.linkedin.md`.
...
- [dev.to thread](DEVTO_URL)
- [Medium response thread](MEDIUM_URL)
- [LinkedIn long-form post](LINKEDIN_URL)
```
...
Record any schedule changes in `docs/content/deep-dive-schedule.md`.
