...
- **Change a category weight.** That's a framework-level RFC against [`03-criteria-part-a.md`](../framework/03-criteria-part-a.md) or [`04-criteria-part-b.md`](../framework/04-criteria-part-b.md); proposed via the framework's own RFC flow, not via your local FIX cycle.

---

*Continue to [`07-maturity-tiers.md`](../framework/07-maturity-tiers.md) for what each L0–L5 tier means and the enterprise-grade thresholds.*
