...
The plan template is at [`templates/improvement-plan-template.md`](../framework/templates/improvement-plan-template.md). The LLM prompt that drafts one for you is at [`prompts/improvement-plan.md`](./prompts/improvement-plan.md). This file explains *why* the plan looks the way it does.
