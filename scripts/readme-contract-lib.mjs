...
export const PAYLOAD_PATH = resolve(ROOT, "docs/docs/FR-DOCS-001-readme-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "docs/_audit/readme-contract.json");
