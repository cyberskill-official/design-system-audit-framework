...
export const PAYLOAD_PATH = resolve(ROOT, "docs/core/FR-CORE-002-regression-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "docs/_audit/no-silent-regression-contract.json");
