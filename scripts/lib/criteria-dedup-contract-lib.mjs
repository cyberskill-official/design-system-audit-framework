...
export function evaluateCriteriaDedupContract(payload, root = ROOT) {
  ...
  results.push(makeResult(liveRows.length === payload.expected_counts.total, "criteria-count-total", "docs/framework/03-criteria-part-a.md + docs/framework/04-criteria-part-b.md", liveRows.length, payload.expected_counts.total));
