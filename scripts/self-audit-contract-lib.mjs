...
export const PAYLOAD_PATH = resolve(ROOT, "docs/branding/FR-CORE-004-self-audit-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "docs/_audit/self-audit-cap-contract.json");
