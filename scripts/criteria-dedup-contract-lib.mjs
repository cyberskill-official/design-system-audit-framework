...
export const PAYLOAD_PATH = resolve(ROOT, "docs/core/FR-CORE-003-dedup-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "docs/_audit/criteria-dedup-contract.json");
...
export function evaluateCriteriaDedupContract(payload, root = ROOT) {
  ...
  results.push(makeResult(liveRows.length === payload.expected_counts.total, "criteria-count-total", "docs/03-criteria-part-a.md + docs/04-criteria-part-b.md", liveRows.length, payload.expected_counts.total));
