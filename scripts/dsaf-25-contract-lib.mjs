...
export const PAYLOAD_PATH = resolve(ROOT, "docs/core/FR-CORE-001-dsaf-25-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "docs/_audit/dsaf-25-contract.json");
