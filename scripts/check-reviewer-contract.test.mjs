...
} from "./reviewer-contract-lib.mjs";
...
function fixtureRepo() {
  ...
  mkdirSync(join(root, "docs/social"), { recursive: true });
  writeFileSync(join(root, payload.files.shortlist), shortlistText());
  writeFileSync(join(root, payload.files.branding_playbook), [
  ...
  writeFileSync(join(root, payload.files.social_drafts), [
    "Nathan Curtis",
    "Sil Bormüller",
    "Brad Frost",
    "exact quote text",
