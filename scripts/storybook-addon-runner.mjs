 ...
 * It runs the DSAF check scripts and returns a compact JSON summary.
 */
...
const checks = [
  ...
  ["bundle_size", "scripts/check-bundle-size.mjs"],
  ["doc_freshness", "scripts/check-doc-freshness.mjs"],
];
