...
export const PAYLOAD_PATH = resolve(ROOT, "docs/docs/FR-DOCS-002-endorsement-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "docs/_audit/endorsement-contract.json");
