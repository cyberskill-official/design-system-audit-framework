...
export const PAYLOAD_PATH = resolve(ROOT, "docs/docs/FR-DOCS-003-launch-blog-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "docs/_audit/launch-blog-contract.json");
