...
export const PAYLOAD_PATH = resolve(ROOT, "docs/branding/FR-BRAND-002-taxonomy-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "docs/_audit/brand-taxonomy-contract.json");
