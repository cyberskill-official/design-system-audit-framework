...
function fixtureRepo() {
  ...
  mkdirSync(join(root, "landing/blog/launch-2026"), { recursive: true });
  mkdirSync(join(root, "assets/og"), { recursive: true });
  mkdirSync(join(root, "landing/assets/og"), { recursive: true });
...
test("evaluateLaunchBlogContract catches missing files and package scripts", () => {
