...
export const PAYLOAD_PATH = resolve(ROOT, "docs/branding/FR-BRAND-003-visual-assets-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "docs/_audit/visual-assets-contract.json");
