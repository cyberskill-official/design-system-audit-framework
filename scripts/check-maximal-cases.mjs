...
if (dirs.length !== 20) failures.push(`expected 20 case directories, found ${dirs.length}`);
if (fileCases.length !== 10) failures.push(`expected 10 file cases, found ${fileCases.length}`);
if (urlCases.length !== 10) failures.push(`expected 10 URL cases, found ${urlCases.length}`);
if (dirs.length * required.length !== 40) failures.push(`expected 40 output files, found ${dirs.length * required.length}`);
