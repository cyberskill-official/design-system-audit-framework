...
const blogDir = join(root, "apps/landing", "blog");
...
const deployAssetsDir = join(root, "apps/landing", "docs/outputs/assets");
...
const deepDiveSourceDir = join(root, 'docs/internal/content/deep-dives');
