...
//
// Output: outputs/_audit/apca-contrast.json
//
...
const OUT = resolve(ROOT, 'docs/outputs/_audit/apca-contrast.json');
...
if (!existsSync(TOKENS)) {
  ...
  console.log('  Output: outputs/_audit/apca-contrast.json');
  process.exit(0);
}
