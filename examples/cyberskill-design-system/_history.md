...
| 2026-05-17 | FIX | DSAF v0.1 + FR-CORE-004 | GPT-5 Codex | Stephen Cheng | Stephen Cheng | unchanged | unchanged | unchanged | **L3 capped** | yes | Reframed as worked example; interior scores intact; cap rationale: `docs/branding/self-audit-policy.md` |
