...
export const PAYLOAD_PATH = resolve(ROOT, "internal/branding/FR-BRAND-003-visual-assets-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "outputs/_audit/visual-assets-contract.json");
