...
export const PAYLOAD_PATH = resolve(ROOT, "framework/core/FR-DOCS-003-launch-blog-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "outputs/_audit/launch-blog-contract.json");
