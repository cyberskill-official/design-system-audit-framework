...
export const PAYLOAD_PATH = resolve(ROOT, "internal/governance/FR-GOV-001-reviewer-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "outputs/_audit/reviewer-contract.json");
