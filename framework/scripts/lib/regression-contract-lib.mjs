...
export const PAYLOAD_PATH = resolve(ROOT, "framework/core/FR-CORE-002-regression-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "outputs/_audit/no-silent-regression-contract.json");
