...
export const PAYLOAD_PATH = resolve(ROOT, "framework/core/FR-DOCS-001-readme-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "outputs/_audit/readme-contract.json");
