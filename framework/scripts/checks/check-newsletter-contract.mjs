...
const PAYLOAD = resolve(ROOT, "internal/social/FR-LAUNCH-006-social-payload.json");
...
assert(payload.observability?.tracking_file === "internal/launch/newsletter-submissions.md", "observability tracking file must point to newsletter runbook");
