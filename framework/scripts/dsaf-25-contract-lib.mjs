...
export const PAYLOAD_PATH = resolve(ROOT, "framework/core/FR-CORE-001-dsaf-25-contract.json");
export const AUDIT_OUTPUT = resolve(ROOT, "outputs/_audit/dsaf-25-contract.json");
