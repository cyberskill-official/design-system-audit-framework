...
DSAF's 0-5 criteria remain the canonical audit score. For strict "push it as far as possible" audits, a reviewer may enable the maximal enterprise overlay in [`framework/bench/maximal-enterprise-benchmark.md`](../framework/bench/maximal-enterprise-benchmark.md).
...
DSAF is opinionated; the criteria are not sacred. See [`09-customising.md`](../guidelines/09-customising.md) for:
...
*End of framework spec. Read [`05-running-an-audit.md`](../guidelines/05-running-an-audit.md) next for the executable playbook.*
