...
- `framework/dsaf-25.md` body gained a worked example under "60-second self-score."
...
The post-revision FR runs ~960 lines, above the 700-line target but justified by the verbatim doctrine surface (`framework/dsaf-25.md` + `framework/dsaf-25-card.md` bodies are ~250 lines combined of verbatim ship-ready content). Every §1 MUST has a verifiable AC; every cross-FR coordination (FR-CORE-002 / FR-CORE-003 / FR-CORE-004 / FR-DOCS-001 / FR-INTEG-* / FR-CLI-001) is explicit. The four-artefact ship contract is concrete and operator-actionable. **Score = 10/10.**
